...
export const products: Product[] = [
   ...
   },
   {
       id: "milo",
       name: "Milo Chocolate",
       subName: "Malted, rich, velvety.",
       price: "₹140",
       description: "Premium Malt - Dark Cocoa - Plant Protein",
       folderPath: "/images/milo",
       frameCount: 171,
       themeColor: "#5D4037",
       gradient: "linear-gradient(135deg, #8D6E63 0%, #5D4037 100%)",
       features: ["Premium Malt", "Dark Cocoa", "Plant Protein"],
       stats: [{ label: "Dairy", val: "0%" }, { label: "Energy", val: "High" }, { label: "Cocoa", val: "100%" }],
       section1: { title: "Milo Chocolate.", subtitle: "Malted energy." },
       section2: { title: "The ultimate malted experience.", subtitle: "Rich, dark cocoa blended with malted goodness and creamy almond milk." },
       section3: { title: "Plant-powered vitality.", subtitle: "Loaded with natural plant protein to fuel your active and busy lifestyle." },
       section4: { title: "Guilt-free indulgence.", subtitle: "" },
       detailsSection: {
           title: "Ethically Sourced Cocoa",
           description: "We source our cocoa and malt from sustainable farms, ensuring fair wages and premium quality. Blended with our house-made almond milk, this drink offers a silky texture that rivals traditional dairy shakes, but with zero cholesterol and 100% plant-based goodness.",
           imageAlt: "Milo Details"
       },
       freshnessSection: {
           title: "Cold-Crafted Malted Mix",
           description: "Heat destroys delicate malt flavonoids. That's why we mix our Milo Chocolate cold. Our almond milk is pressed fresh daily, never stored. The result is a clean, robust chocolate flavor that feels heavy on the tongue but light on the stomach."
       },
       buyNowSection: {
           price: "₹140",
           unit: "per 300ml bottle",
           ...
           returnPolicy: "Taste the malt difference or get your money back."
       }
   },
   {
       id: "pomegranate",
